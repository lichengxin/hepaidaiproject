...
public class FragmentStockDealCancel extends BaseFragment  {

	private static final String LOGTAG = FragmentStockDealCancel.class.getSimpleName();
    ...
    protected int getLayoutId() {
        return R.layout.pkg_vstock_fragment_stockdealcancel;
    }
