...
import net.okhttp.internal.Internal;
import net.okhttp.internal.InternalCache;
import net.okhttp.internal.Network;
import net.okhttp.internal.RouteDatabase;
import net.okhttp.internal.Util;
import net.okhttp.internal.http.AuthenticatorAdapter;
...
import net.okhttp.internal.tls.OkHostnameVerifier;
...
public class OkHttpClient implements Cloneable {
  private static final List<net.http.Protocol.ProtocolVersion> DEFAULT_PROTOCOLS = Util.immutableList(
		  net.http.Protocol.ProtocolVersion.HTTP_2, 
		  net.http.Protocol.ProtocolVersion.SPDY_3, 
		  net.http.Protocol.ProtocolVersion.HTTP_1_1);
  ...
  static {
    Internal.instance = new Internal() {
      ...
      @Override public void setProtocol(Connection connection, net.http.Protocol.ProtocolVersion protocol) {
  ...
  private Proxy proxy;
  private List<net.http.Protocol.ProtocolVersion> protocols;
   ...
   */
  public OkHttpClient setProtocols(List<net.http.Protocol.ProtocolVersion> protocols) {
    protocols = Util.immutableList(protocols);
    if (!protocols.contains(net.http.Protocol.ProtocolVersion.HTTP_1_1)) {
      throw new IllegalArgumentException("protocols doesn't contain http/1.1: " + protocols);
    }
    if (protocols.contains(net.http.Protocol.ProtocolVersion.HTTP_1_0)) {
  ...
  public List<net.http.Protocol.ProtocolVersion> getProtocols() {
    return protocols;
  }
