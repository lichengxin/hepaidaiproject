...
import sys.io.Timeout;

import static java.lang.String.format;
import static java.util.logging.Level.FINE;
import static net.okhttp.internal.framed.Http2.FrameLogger.formatHeader;
import static sys.io.ByteString.EMPTY;
...
public final class Http2 implements Variant {
  ...
  @Override public net.http.Protocol.ProtocolVersion getProtocol() {
    return net.http.Protocol.ProtocolVersion.HTTP_2;
  }
