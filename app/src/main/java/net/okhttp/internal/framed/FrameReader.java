...
public interface FrameReader extends java.io.Closeable {
  void readConnectionPreface() throws java.io.IOException;
  boolean nextFrame(Handler handler) throws java.io.IOException;
