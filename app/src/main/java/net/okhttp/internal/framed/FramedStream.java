...
public final class FramedStream {
   ...
   */
  public synchronized java.util.List<Header> getResponseHeaders() throws java.io.IOException {
    readTimeout.enter();
    try {
    ...
    throw new java.io.IOException("stream was reset: " + errorCode);
  }
   ...
   */
  public void reply(java.util.List<Header> responseHeaders, boolean out) throws java.io.IOException {
  ...
  public sys.io.Timeout readTimeout() {
    return readTimeout;
  }

  public sys.io.Timeout writeTimeout() {
    return writeTimeout;
  }

  /** Returns a source that reads data from the peer. */
  public sys.io.Source getSource() {
    return source;
  }
   ...
   */
  public void close(ErrorCode rstStatusCode) throws java.io.IOException {
  ...
  void receiveHeaders(java.util.List<Header> headers, HeadersMode headersMode) {
    assert (!Thread.holdsLock(FramedStream.this));
      ...
      if (responseHeaders == null) {
        ...
        if (headersMode.failIfHeadersPresent()) {
          errorCode = ErrorCode.STREAM_IN_USE;
        	...
        	java.util.List<Header> newHeaders = new java.util.ArrayList<>();
  ...
  void receiveData(sys.io.BufferedSource in, int length) throws java.io.IOException {
    assert (!Thread.holdsLock(FramedStream.this));
   ...
   */
  private final class FramedDataSource implements sys.io.Source {
    /** Buffer to receive data from the network into. Only accessed by the reader thread. */
    private final sys.io.Buffer receiveBuffer = new sys.io.Buffer();

    /** Buffer with readable data. Guarded by FramedStream.this. */
    private final sys.io.Buffer readBuffer = new sys.io.Buffer();
    ...
    void receive(sys.io.BufferedSource in, long byteCount) throws java.io.IOException {
      assert (!Thread.holdsLock(FramedStream.this));
   ...
   * thread safe.
   */
  final class FramedDataSink implements sys.io.Sink {
     ...
     */
    private final sys.io.Buffer sendBuffer = new sys.io.Buffer();
    ...
    @Override public void write(sys.io.Buffer source, long byteCount) throws java.io.IOException {
      assert (!Thread.holdsLock(FramedStream.this));
     ...
     */
    private void emitDataFrame(boolean outFinished) throws java.io.IOException {
      long toWrite;
      synchronized (FramedStream.this) {
        writeTimeout.enter();
        try {
   ...
   */
  class StreamTimeout extends sys.io.AsyncTimeout {
    @Override protected void timedOut() {
      closeLater(ErrorCode.CANCEL);
    }

    @Override protected java.io.IOException newTimeoutException(java.io.IOException cause) {
