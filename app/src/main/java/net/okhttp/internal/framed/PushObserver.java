...
/**
 * {@link com.base.net.okhttp.Protocol#HTTP_2 HTTP/2} only.
...
public interface PushObserver {
   ...
   */
  boolean onRequest(int streamId, java.util.List<Header> requestHeaders);
   ...
   */
  boolean onHeaders(int streamId, java.util.List<Header> responseHeaders, boolean last);
   ...
   */
  boolean onData(int streamId, sys.io.BufferedSource source, int byteCount, boolean last)
  ...
  PushObserver CANCEL = new PushObserver() {
    ...
    @Override public boolean onRequest(int streamId, java.util.List<Header> requestHeaders) {
      return true;
    }

    @Override public boolean onHeaders(int streamId, java.util.List<Header> responseHeaders, boolean last) {
      return true;
    }

    @Override public boolean onData(int streamId, sys.io.BufferedSource source, int byteCount,
        boolean last) throws java.io.IOException {
