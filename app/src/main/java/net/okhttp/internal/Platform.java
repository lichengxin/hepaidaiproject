...
public class Platform {
  ...
  public void configureTlsExtensions(SSLSocket sslSocket, String hostname,
      List<net.http.Protocol.ProtocolVersion> protocols) {
  }
  ...
  private static class Android extends Platform {
    ...
    @Override public void configureTlsExtensions(
        SSLSocket sslSocket, String hostname, List<net.http.Protocol.ProtocolVersion> protocols) {
  ...
  private static class JdkWithJettyBootPlatform extends Platform {
    ...
    @Override public void configureTlsExtensions(
      ...
      for (int i = 0, size = protocols.size(); i < size; i++) {
    	  net.http.Protocol.ProtocolVersion protocol = protocols.get(i);
        if (protocol == net.http.Protocol.ProtocolVersion.HTTP_1_0) continue; // No HTTP/1.0 for ALPN.
   ...
   */
  static byte[] concatLengthPrefixed(List<net.http.Protocol.ProtocolVersion> protocols) {
