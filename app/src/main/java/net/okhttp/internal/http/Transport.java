...
public interface Transport {
  ...
  sys.io.Sink createRequestBody(net.okhttp.Request request, long contentLength) throws IOException;

  /** This should update the HTTP engine's sentRequestMillis field. */
  void writeRequestHeaders(net.okhttp.Request request) throws IOException;
  ...
  net.okhttp.Response.Builder readResponseHeaders() throws IOException;

  /** Returns a stream that reads the response body. */
  net.okhttp.ResponseBody openResponseBody(net.okhttp.Response response) throws IOException;
