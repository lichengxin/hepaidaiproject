...
import static net.okhttp.internal.Util.closeQuietly;
import static net.okhttp.internal.http.StatusLine.HTTP_CONTINUE;
import static net.okhttp.internal.http.StatusLine.HTTP_PERM_REDIRECT;
import static net.okhttp.internal.http.StatusLine.HTTP_TEMP_REDIRECT;
...
public final class HttpEngine {
  ...
  private static final net.okhttp.ResponseBody EMPTY_BODY = new net.okhttp.ResponseBody() {
    ...
    @Override public sys.io.BufferedSource source() {
      return new sys.io.Buffer();
    }
  };

  final net.okhttp.OkHttpClient client;

  private net.okhttp.Connection connection;
  private net.okhttp.Address address;
  private RouteSelector routeSelector;
  private net.okhttp.Route route;
  private final net.okhttp.Response priorResponse;
   ...
   */
  private final net.okhttp.Request userRequest;
   ...
   */
  private net.okhttp.Request networkRequest;
   ...
   */
  private net.okhttp.Response cacheResponse;
   ...
   */
  private net.okhttp.Response userResponse;

  private sys.io.Sink requestBodyOut;
  private sys.io.BufferedSink bufferedRequestBody;
   ...
   */
  public HttpEngine(net.okhttp.OkHttpClient client, net.okhttp.Request request, boolean bufferRequestBody,
      boolean callerWritesRequestBody, boolean forWebSocket, net.okhttp.Connection connection,
      RouteSelector routeSelector, RetryableSink requestBodyOut, net.okhttp.Response priorResponse) {
    this.client = client;
    ...
    if (connection != null) {
    	net.okhttp.internal.Internal.instance.setOwner(connection, this);
  ...
  public void sendRequest() throws RequestException, RouteException, IOException {
    ...
    net.okhttp.Request request = networkRequest(userRequest);

    net.okhttp.internal.InternalCache responseCache = net.okhttp.internal.Internal.instance.internalCache(client);
    net.okhttp.Response cacheCandidate = responseCache != null
    ...
    if (networkRequest != null) {
      ...
      transport = net.okhttp.internal.Internal.instance.newTransport(connection, this);
      ...
      if (connection != null) {
    	  net.okhttp.internal.Internal.instance.recycle(client.getConnectionPool(), connection);
        connection = null;
      }
      ...
      if (cacheResponse != null) {
        ...
        this.userResponse = new net.okhttp.Response.Builder()
            .request(userRequest)
            .priorResponse(stripBody(priorResponse))
            .protocol(net.http.Protocol.ProtocolVersion.HTTP_1_1)
            .code(504)
  ...
  private static net.okhttp.Response stripBody(net.okhttp.Response response) {
  ...
  private void connect() throws RequestException, RouteException {
    ...
    net.okhttp.internal.Internal.instance.connectAndSetOwner(client, connection, this, networkRequest);
    route = connection.getRoute();
  }

  private net.okhttp.Connection createNextConnection() throws RouteException {
	  net.okhttp.ConnectionPool pool = client.getConnectionPool();

    // Always prefer pooled connections over new connections.
    for (net.okhttp.Connection pooled; (pooled = pool.get(address)) != null; ) {
      if (networkRequest.method().equals("GET") || 
    		  net.okhttp.internal.Internal.instance.isReadable(pooled)) {
        return pooled;
      }
    ...
    try {
    	net.okhttp.Route route = routeSelector.next();
      return new net.okhttp.Connection(pool, route);
    } catch (IOException e) {
  ...
  boolean permitsRequestBody(net.okhttp.Request request) {
    return net.http.Protocol.permitsRequestBody(request.method());
  }

  /** Returns the request body or null if this request doesn't have a body. */
  public sys.io.Sink getRequestBody() {
    if (cacheStrategy == null) throw new IllegalStateException();
    return requestBodyOut;
  }

  public sys.io.BufferedSink getBufferedRequestBody() {
	  sys.io.BufferedSink result = bufferedRequestBody;
    if (result != null) return result;
    sys.io.Sink requestBody = getRequestBody();
    return requestBody != null
        ? (bufferedRequestBody = sys.io.Okio.buffer(requestBody))
        : null;
  }
  ...
  public net.okhttp.Request getRequest() {
    return userRequest;
  }

  /** Returns the engine's response. */
  // TODO: the returned body will always be null.
  public net.okhttp.Response getResponse() {
    if (userResponse == null) throw new IllegalStateException();
    return userResponse;
  }

  public net.okhttp.Connection getConnection() {
    return connection;
  }
  ...
  public HttpEngine recover(RouteException e) {
    ...
    net.okhttp.Connection connection = close();
  ...
  private boolean isRecoverable(RouteException e) {
    ...
    if (ioe instanceof java.net.ProtocolException) {
      return false;
    }
    ...
    if (ioe instanceof java.io.InterruptedIOException) {
      return ioe instanceof java.net.SocketTimeoutException;
    }
   ...
   * body is buffered.
   */
  public HttpEngine recover(IOException e, sys.io.Sink requestBodyOut) {
    if (routeSelector != null && connection != null) {
  ...
  private void connectFailed(RouteSelector routeSelector, IOException e) {
    ...
    if (net.okhttp.internal.Internal.instance.recycleCount(connection) > 0) return;
    net.okhttp.Route failedRoute = connection.getRoute();
   ...
   */
  public net.okhttp.Route getRoute() {
    return route;
  }
  ...
  private void maybeCache() throws IOException {
    ...
    if (!CacheStrategy.isCacheable(userResponse, networkRequest)) {
      if (net.http.Protocol.invalidatesCache(networkRequest.method())) {
        try {
    ...
    try {
      if (transport != null) {
        transport.disconnect(this);
    	  ...
    	  net.okhttp.Connection connection = this.connection;
        if (connection != null) {
        	net.okhttp.internal.Internal.instance.closeIfOwnedBy(connection, this);
        }
      }
    } catch (IOException ignored) {
    }
   ...
   */
  public net.okhttp.Connection close() {
    ...
    if (connection != null && !net.okhttp.internal.Internal.instance.clearOwner(connection)) {
      connection = null;
    }

    net.okhttp.Connection result = connection;
    connection = null;
    return result;
  }
   ...
   */
  private net.okhttp.Response unzip(final net.okhttp.Response response) throws IOException {
    ...
    sys.io.GzipSource responseBody = new sys.io.GzipSource(response.body().source());
    net.okhttp.Headers strippedHeaders = response.headers().newBuilder()
        .removeAll("Content-Encoding")
        .removeAll("Content-Length")
        .build();
    return response.newBuilder()
        .headers(strippedHeaders)
        .body(new RealResponseBody(strippedHeaders, sys.io.Okio.buffer(responseBody)))
        .build();
  }
   ...
   */
  public static boolean hasBody(net.okhttp.Response response) {
   ...
   */
  private net.okhttp.Request networkRequest(net.okhttp.Request request) throws IOException {
	  net.okhttp.Request.Builder result = request.newBuilder();

    if (request.header("Host") == null) {
      result.header("Host", net.okhttp.internal.Util.hostHeader(request.httpUrl()));
    }

    if ((connection == null || connection.getProtocol() != net.http.Protocol.ProtocolVersion.HTTP_1_0)
    ...
    java.net.CookieHandler cookieHandler = client.getCookieHandler();
    if (cookieHandler != null) {
      // Capture the request headers added so far so that they can be offered to the CookieHandler.
      // This is mostly to stay close to the RI; it is unlikely any of the headers above would
      // affect cookie choice besides "Host".
    	java.util.Map<String, java.util.List<String>> headers = OkHeaders.toMultimap(result.build().headers(), null);

    	java.util.Map<String, java.util.List<String>> cookies = cookieHandler.get(request.uri(), headers);
    ...
    if (request.header("User-Agent") == null) {
      result.header("User-Agent", net.okhttp.internal.Version.userAgent());
    }
  ...
  public void readResponse() throws IOException {
    ...
    net.okhttp.Response networkResponse;
  ...
  class NetworkInterceptorChain implements net.okhttp.Interceptor.Chain {
    private final int index;
    private final net.okhttp.Request request;
    private int calls;

    NetworkInterceptorChain(int index, net.okhttp.Request request) {
      this.index = index;
      this.request = request;
    }

    @Override public net.okhttp.Connection connection() {
      return connection;
    }

    @Override public net.okhttp.Request request() {
      return request;
    }

    @Override public net.okhttp.Response proceed(net.okhttp.Request request) throws IOException {
      calls++;

      if (index > 0) {
    	  net.okhttp.Interceptor caller = client.networkInterceptors().get(index - 1);
        net.okhttp.Address address = connection().getRoute().getAddress();
      ...
      if (index < client.networkInterceptors().size()) {
        ...
        net.okhttp.Interceptor interceptor = client.networkInterceptors().get(index);
        net.okhttp.Response interceptedResponse = interceptor.intercept(chain);
      ...
      if (permitsRequestBody(request) && request.body() != null) {
    	  sys.io.Sink requestBodyOut = transport.createRequestBody(request, request.body().contentLength());
    	  sys.io.BufferedSink bufferedRequestBody = sys.io.Okio.buffer(requestBodyOut);
        request.body().writeTo(bufferedRequestBody);
        bufferedRequestBody.close();
      }

      net.okhttp.Response response = readNetworkResponse();
  ...
  private net.okhttp.Response readNetworkResponse() throws IOException {
    transport.finishRequest();

    net.okhttp.Response networkResponse = transport.readResponseHeaders()
    ...
    net.okhttp.internal.Internal.instance.setProtocol(connection, networkResponse.protocol());
   ...
   */
  private net.okhttp.Response cacheWritingResponse(final CacheRequest cacheRequest, net.okhttp.Response response)
      throws IOException {
    // Some apps return a null body; for compatibility we treat that like a null cache request.
    if (cacheRequest == null) return response;
    sys.io.Sink cacheBodyUnbuffered = cacheRequest.body();
    if (cacheBodyUnbuffered == null) return response;

    final sys.io.BufferedSource source = response.body().source();
    final sys.io.BufferedSink cacheBody = sys.io.Okio.buffer(cacheBodyUnbuffered);

    sys.io.Source cacheWritingSource = new sys.io.Source() {
      boolean cacheRequestClosed;

      @Override public long read(sys.io.Buffer sink, long byteCount) throws IOException {
        long bytesRead;
        try {
      ...
      @Override public void close() throws IOException {
        if (!cacheRequestClosed
            && !net.okhttp.internal.Util.discard(this, Transport.DISCARD_STREAM_TIMEOUT_MILLIS, MILLISECONDS)) {
          cacheRequestClosed = true;
          cacheRequest.abort();
        }
        source.close();
    ...
    return response.newBuilder()
        .body(new RealResponseBody(response.headers(), sys.io.Okio.buffer(cacheWritingSource)))
        .build();
  }
   ...
   */
  private static boolean validate(net.okhttp.Response cached, net.okhttp.Response network) {
    ...
    java.util.Date lastModified = cached.headers().getDate("Last-Modified");
    if (lastModified != null) {
    	java.util.Date networkLastModified = network.headers().getDate("Last-Modified");
   ...
   * 13.5.3.
   */
  private static net.okhttp.Headers combine(
		  net.okhttp.Headers cachedHeaders, 
		  net.okhttp.Headers networkHeaders) throws IOException {
	  net.okhttp.Headers.Builder result = new net.okhttp.Headers.Builder();
  ...
  public void receiveHeaders(net.okhttp.Headers headers) throws IOException {
	  java.net.CookieHandler cookieHandler = client.getCookieHandler();
    if (cookieHandler != null) {
   ...
   */
  public net.okhttp.Request followUpRequest() throws IOException {
    if (userResponse == null) throw new IllegalStateException();
    java.net.Proxy selectedProxy = getRoute() != null
        ? getRoute().getProxy()
        : client.getProxy();
    ...
    switch (responseCode) {
      case HTTP_PROXY_AUTH:
        if (selectedProxy.type() != java.net.Proxy.Type.HTTP) {
      ...
      case HTTP_SEE_OTHER:
        ...
        net.okhttp.HttpUrl url = userRequest.httpUrl().resolve(location);
        ...
        net.okhttp.Request.Builder requestBuilder = userRequest.newBuilder();
        if (net.http.Protocol.permitsRequestBody(userRequest.method())) {
   ...
   */
  public boolean sameConnection(net.okhttp.HttpUrl followUp) {
	  net.okhttp.HttpUrl url = userRequest.httpUrl();
    return url.host().equals(followUp.host())
        && url.port() == followUp.port()
        && url.scheme().equals(followUp.scheme());
  }

  private static net.okhttp.Address createAddress(
		  net.okhttp.OkHttpClient client, 
		  net.okhttp.Request request) {
    SSLSocketFactory sslSocketFactory = null;
    HostnameVerifier hostnameVerifier = null;
    net.okhttp.CertificatePinner certificatePinner = null;
    if (request.isHttps()) {
    ...
    return new net.okhttp.Address(request.httpUrl().host(), request.httpUrl().port(),
