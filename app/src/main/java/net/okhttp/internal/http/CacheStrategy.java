...
public final class CacheStrategy {
  ...
  public final net.okhttp.Request networkRequest;

  /** The cached response to return or validate; or null if this call doesn't use a cache. */
  public final net.okhttp.Response cacheResponse;

  private CacheStrategy(net.okhttp.Request networkRequest, net.okhttp.Response cacheResponse) {
   ...
   * request.
   */
  public static boolean isCacheable(net.okhttp.Response response, 
  ...
  public static class Factory {
    ...
    final net.okhttp.Request request;
    final net.okhttp.Response cacheResponse;
    ...
    public Factory(long nowMillis, 
    		net.okhttp.Request request, 
    		net.okhttp.Response cacheResponse) {
      this.nowMillis = nowMillis;
      this.request = request;
      this.cacheResponse = cacheResponse;

      if (cacheResponse != null) {
    	  net.okhttp.Headers headers = cacheResponse.headers();
    ...
    private CacheStrategy getCandidate() {
      ...
      net.okhttp.CacheControl requestCaching = request.cacheControl();
      ...
      net.okhttp.CacheControl responseCaching = cacheResponse.cacheControl();
      if (!responseCaching.mustRevalidate() && requestCaching.maxStaleSeconds() != -1) {
        maxStaleMillis = SECONDS.toMillis(requestCaching.maxStaleSeconds());
      }

      if (!responseCaching.noCache() && ageMillis + minFreshMillis < freshMillis + maxStaleMillis) {
    	  net.okhttp.Response.Builder builder = cacheResponse.newBuilder();
      ...
      net.okhttp.Request.Builder conditionalRequestBuilder = request.newBuilder();
      ...
      net.okhttp.Request conditionalRequest = conditionalRequestBuilder.build();
     ...
     */
    private static boolean hasConditions(net.okhttp.Request request) {
