...
public final class Response {
   ...
   * Protocol#HTTP_1_0}.
   */
  public net.http.Protocol.ProtocolVersion protocol() {
    return protocol;
  }
  ...
  public static class Builder {
    ...
    private net.http.Protocol.ProtocolVersion protocol;
    private int code = -1;
    ...
    public Builder priorResponse(net.okhttp.Response priorResponse) {
      if (priorResponse != null) checkPriorResponse(priorResponse);
      this.priorResponse = priorResponse;
      return this;
    }

    private void checkPriorResponse(net.okhttp.Response response) {
      if (response.body != null) {
