...
public final class Address {
  ...
  final List<Protocol.ProtocolVersion> protocols;
  ...
  public Address(String uriHost, int uriPort, SocketFactory socketFactory,
      ...
      List<Protocol.ProtocolVersion> protocols, List<ConnectionSpec> connectionSpecs, ProxySelector proxySelector) {
   ...
   */
  public List<Protocol.ProtocolVersion> getProtocols() {
    return protocols;
  }
