...
import sys.io.Source;

import net.okhttp.internal.ConnectionSpecSelector;
import net.okhttp.internal.Platform;
import net.okhttp.internal.Util;
import net.okhttp.internal.framed.FramedConnection;
import net.okhttp.internal.http.FramedTransport;
import net.okhttp.internal.http.HttpConnection;
import net.okhttp.internal.http.HttpEngine;
import net.okhttp.internal.http.HttpTransport;
import net.okhttp.internal.http.OkHeaders;
...
public final class Connection {
  ...
  private net.http.Protocol.ProtocolVersion protocol = net.http.Protocol.ProtocolVersion.HTTP_1_1;
  ...
  private void connectSocket(int connectTimeout, int readTimeout, int writeTimeout,
    ...
    if (protocol == net.http.Protocol.ProtocolVersion.SPDY_3 || 
    	protocol == net.http.Protocol.ProtocolVersion.HTTP_2) {
  ...
  private void connectTls(int readTimeout, int writeTimeout, Request request,
    ...
    try {
      ...
      protocol = maybeProtocol != null
          ? net.http.Protocol.ProtocolVersion.get(maybeProtocol)
   ...
   */
  void setProtocol(net.http.Protocol.ProtocolVersion protocol) {
