...
public final class CacheControl {
  ...
  public static CacheControl parse(Headers headers) {
    ...
    for (int i = 0, size = headers.size(); i < size; i++) {
      ...
      while (pos < value.length()) {
        int tokenStart = pos;
        pos = net.okhttp.internal.http.HeaderParser.skipUntil(value, pos, "=,;");
        ...
        if (pos == value.length() || value.charAt(pos) == ',' || value.charAt(pos) == ';') {
          ...
          pos++; // consume '='
          pos = net.okhttp.internal.http.HeaderParser.skipWhitespace(value, pos);
        ...
        if ("no-cache".equalsIgnoreCase(directive)) {
          ...
          maxAgeSeconds = net.okhttp.internal.http.HeaderParser.parseSeconds(parameter, -1);
        } else if ("s-maxage".equalsIgnoreCase(directive)) {
          sMaxAgeSeconds = net.okhttp.internal.http.HeaderParser.parseSeconds(parameter, -1);
          ...
          maxStaleSeconds = net.okhttp.internal.http.HeaderParser.parseSeconds(parameter, Integer.MAX_VALUE);
        } else if ("min-fresh".equalsIgnoreCase(directive)) {
          minFreshSeconds = net.okhttp.internal.http.HeaderParser.parseSeconds(parameter, -1);
  ...
  public static final class Builder {
     ...
     */
    public Builder maxAge(int maxAge, java.util.concurrent.TimeUnit timeUnit) {
     ...
     *     lost.
     */
    public Builder maxStale(int maxStale, java.util.concurrent.TimeUnit timeUnit) {
     ...
     *     lost.
     */
    public Builder minFresh(int minFresh, java.util.concurrent.TimeUnit timeUnit) {
