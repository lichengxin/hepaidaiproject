...
public final class Request {
  ...
  private volatile java.net.URL javaNetUrl; // Lazily initialized.
  private volatile java.net.URI javaNetUri; // Lazily initialized.
  ...
  public static class Builder {
    ...
    public Builder method(String method, RequestBody body) {
      ...
      if (body != null && !net.http.Protocol.permitsRequestBody(method)) {
        throw new IllegalArgumentException("method " + method + " must not have a request body.");
      }
      if (body == null && net.http.Protocol.requiresRequestBody(method)) {
