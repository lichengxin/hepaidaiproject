...
import net.okhttp.internal.http.RequestException;
import net.okhttp.internal.http.RouteException;

import static net.okhttp.internal.Internal.logger;
import static net.okhttp.internal.http.HttpEngine.MAX_FOLLOW_UPS;
...
public class Call {
  ...
  public Response execute() throws java.io.IOException {
    ...
    try {
      ...
      if (result == null) throw new java.io.IOException("Canceled");
      return result;
    } finally {
    ...
    @Override protected void execute() {
      ...
      try {
        ...
        if (canceled) {
          ...
          responseCallback.onFailure(originalRequest, new java.io.IOException("Canceled"));
        } else {
          signalledCallback = true;
  ...
  private Response getResponseWithInterceptorChain(boolean forWebSocket) throws java.io.IOException {
  ...
  class ApplicationInterceptorChain implements Interceptor.Chain {
    ...
    @Override public Response proceed(Request request) throws java.io.IOException {
   ...
   * call was canceled.
   */
  Response getResponse(Request request, boolean forWebSocket) throws java.io.IOException {
