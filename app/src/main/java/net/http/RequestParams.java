...
import net.http.client.entity.BodyParamsEntity;
import net.http.client.multipart.HttpMultipartMode;
import net.http.client.multipart.MultipartEntity;
import net.http.client.multipart.content.ContentBody;
import net.http.client.multipart.content.FileBody;
import net.http.client.multipart.content.InputStreamBody;
import net.http.client.multipart.content.StringBody;
...
import framework.task.Priority;
