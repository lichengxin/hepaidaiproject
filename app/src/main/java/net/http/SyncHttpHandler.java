...
public class SyncHttpHandler {
    ...
    public ResponseStream sendRequest(HttpRequestBase request) throws HttpException {
        ...
        while (true) {
            ...
            try {
                ...
                exception = new java.io.IOException(e.getMessage());
    ...
    private ResponseStream handleResponse(org.apache.http.HttpResponse response) throws HttpException, java.io.IOException {
        if (response == null) {
