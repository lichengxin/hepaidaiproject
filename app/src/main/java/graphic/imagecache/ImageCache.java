 ...
 * <p>
 * <em>Note:</em> The {@link ImageCache} is accessed by multiple threads. You must ensure
 * your {@link ImageCache} implementation is thread safe when {@link ImageCache#get(String)} or {@link
 * ImageCache#set(String, android.graphics.Bitmap)} is called.
 */
public interface ImageCache {
  ...
  ImageCache NONE = new ImageCache() {
