...
import static graphic.imagecache.Picasso.Priority.LOW;
import static graphic.imagecache.Utils.OWNER_HUNTER;
import static graphic.imagecache.Utils.VERB_DECODED;
import static graphic.imagecache.Utils.VERB_EXECUTING;
import static graphic.imagecache.Utils.VERB_JOINED;
import static graphic.imagecache.Utils.VERB_REMOVED;
import static graphic.imagecache.Utils.VERB_TRANSFORMED;
...
class BitmapHunter implements Runnable {
  ...
  BitmapHunter(Picasso picasso, Dispatcher dispatcher, ImageCache cache, Stats stats, Action action,
  ...
  static BitmapHunter forRequest(Picasso picasso, Dispatcher dispatcher, ImageCache cache, Stats stats,
      Action action) {
