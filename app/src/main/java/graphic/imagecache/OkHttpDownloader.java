...
import net.okhttp.CacheControl;
import net.okhttp.OkHttpClient;
import net.okhttp.Request;
import net.okhttp.ResponseBody;
...
public class OkHttpDownloader implements Downloader {
  ...
  public OkHttpDownloader(final File cacheDir, final long maxSize) {
    ...
    client.setCache(new net.okhttp.Cache(cacheDir, maxSize));
    /*/
    try {
      client.setCache(new com.base.net.okhttp.Cache(cacheDir, maxSize));
  ...
  @Override public Response load(Uri uri, int networkPolicy) throws IOException {
    ...
    net.okhttp.Response response = client.newCall(builder.build()).execute();
  ...
  @Override public void shutdown() {
    net.okhttp.Cache cache = client.getCache();
    if (cache != null) {
      try {
        cache.close();
      } catch (IOException ignored) {
