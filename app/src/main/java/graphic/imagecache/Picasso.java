...
import static graphic.imagecache.Action.RequestWeakReference;
import static graphic.imagecache.Dispatcher.HUNTER_BATCH_COMPLETE;
import static graphic.imagecache.Dispatcher.REQUEST_BATCH_RESUME;
import static graphic.imagecache.Dispatcher.REQUEST_GCED;
...
import static graphic.imagecache.Utils.THREAD_LEAK_CLEANING_MS;
import static graphic.imagecache.Utils.THREAD_PREFIX;
import static graphic.imagecache.Utils.VERB_CANCELED;
import static graphic.imagecache.Utils.VERB_COMPLETED;
import static graphic.imagecache.Utils.VERB_ERRORED;
import static graphic.imagecache.Utils.VERB_RESUMED;
...
public class Picasso {
  ...
  Picasso(Context context, Dispatcher dispatcher, ImageCache cache, Listener listener,
