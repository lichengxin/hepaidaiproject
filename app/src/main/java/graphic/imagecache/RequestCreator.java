...
import static graphic.imagecache.BitmapHunter.forRequest;
import static graphic.imagecache.MemoryPolicy.NO_CACHE;
import static graphic.imagecache.MemoryPolicy.NO_STORE;
import static graphic.imagecache.MemoryPolicy.shouldReadFromMemoryCache;
import static graphic.imagecache.Picasso.Priority;
import static graphic.imagecache.Picasso.LoadedFrom.MEMORY;
import static graphic.imagecache.PicassoDrawable.setBitmap;
import static graphic.imagecache.PicassoDrawable.setPlaceholder;
import static graphic.imagecache.RemoteViewsAction.AppWidgetAction;
import static graphic.imagecache.RemoteViewsAction.NotificationAction;
import static graphic.imagecache.Utils.OWNER_MAIN;
import static graphic.imagecache.Utils.VERB_CHANGED;
import static graphic.imagecache.Utils.VERB_COMPLETED;
import static graphic.imagecache.Utils.VERB_CREATED;
import static graphic.imagecache.Utils.checkMain;
import static graphic.imagecache.Utils.checkNotMain;
import static graphic.imagecache.Utils.createKey;
import static graphic.imagecache.Utils.log;
...
public class RequestCreator {
   ...
   * {@link ImageCache} implementation is not guaranteed to be thread-safe.
   */
