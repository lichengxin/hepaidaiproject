...
public class CharsetUtils {
    ...
    public static String ansi2Utf8(String AData) {
    	try {
			return org.apache.http.util.EncodingUtils.getString(AData.getBytes("utf-8"), "utf-8");
    ...
    public static final String DEFAULT_ENCODING_CHARSET = org.apache.http.protocol.HTTP.DEFAULT_CONTENT_CHARSET;
