...
import sys.exception.BaseException;

import android.content.Context;
import android.os.Environment;
import base.app.AppConfig;
...
public class FileUtils
{
	...
	public static boolean sdcardUsable() {
		...
		if (Environment.MEDIA_MOUNTED.equals(state)) {// 是否插着sd卡
			...
			if (sdFile.exists() && sdFile.canRead() && sdFile.canWrite()) {
				return true;
			} else {
				return false;
			}
	...
	public static String getTempFolder() {
		...
		sb.append(AppConfig.APP_CONFIG_DEFAULT_STOREPATH).append("files/");
