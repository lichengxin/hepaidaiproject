...
public interface BufferedSource extends Source {
   ...
   * returns the string.
   */
  String readUtf8(long byteCount) throws java.io.IOException;
   ...
   */
  String readUtf8Line() throws java.io.IOException;
   ...
   */
  String readUtf8LineStrict() throws java.io.IOException;
   ...
   * the string.
   */
  String readString(java.nio.charset.Charset charset) throws java.io.IOException;

  /**
   * Removes {@code byteCount} bytes from this, decodes them as {@code charset},
   * and returns the string.
   */
  String readString(long byteCount, java.nio.charset.Charset charset) throws java.io.IOException;
