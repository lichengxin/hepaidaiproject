...
import static sys.io.Util.checkOffsetAndCount;
...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
  ...
  @Override public void require(long byteCount) throws java.io.EOFException {
    if (size < byteCount) throw new java.io.EOFException();
  }
  ...
  @Override public java.io.InputStream inputStream() {
  ...
  public Buffer copyTo(java.io.OutputStream out) throws java.io.IOException {
   ...
   * {@code out}.
   */
  public Buffer copyTo(java.io.OutputStream out, long offset, long byteCount) throws java.io.IOException {
  ...
  public Buffer writeTo(java.io.OutputStream out) throws java.io.IOException {
    return writeTo(out, size);
  }

  /** Write {@code byteCount} bytes from this to {@code out}. */
  public Buffer writeTo(java.io.OutputStream out, long byteCount) throws java.io.IOException {
    if (out == null) throw new IllegalArgumentException("out == null");
  ...
  public Buffer readFrom(java.io.InputStream in) throws java.io.IOException {
    readFrom(in, Long.MAX_VALUE, true);
    return this;
  }

  /** Read {@code byteCount} bytes from {@code in} to this. */
  public Buffer readFrom(java.io.InputStream in, long byteCount) throws java.io.IOException {
    if (byteCount < 0) throw new IllegalArgumentException("byteCount < 0: " + byteCount);
    readFrom(in, byteCount, false);
    return this;
  }

  private void readFrom(java.io.InputStream in, long byteCount, boolean forever) throws java.io.IOException {
  ...
  @Override public short readShortLe() {
    return utils.BytesUtils.reverseBytesShort(readShort());
  }

  @Override public int readIntLe() {
    return utils.BytesUtils.reverseBytesInt(readInt());
  }

  @Override public long readLongLe() {
    return utils.BytesUtils.reverseBytesLong(readLong());
  }
  ...
  @Override public ByteString readByteString(long byteCount) throws java.io.EOFException {
    return new ByteString(readByteArray(byteCount));
  }

  @Override public void readFully(Buffer sink, long byteCount) throws java.io.EOFException {
    if (size < byteCount) {
  ...
  @Override public long readAll(Sink sink) throws java.io.IOException {
    long byteCount = size;
    if (byteCount > 0) {
      sink.write(this, byteCount);
    }
  ...
  @Override public String readUtf8(long byteCount) throws java.io.EOFException {
  ...
  @Override public String readString(long byteCount, Charset charset) throws java.io.EOFException {
    checkOffsetAndCount(size, 0, byteCount);
  ...
  @Override public String readUtf8Line() throws java.io.EOFException {
  ...
  @Override public String readUtf8LineStrict() throws java.io.EOFException {
    long newline = indexOf((byte) '\n');
    if (newline == -1) {
  ...
  String readUtf8Line(long newline) throws java.io.EOFException {
  ...
  @Override public int readUtf8CodePoint() throws java.io.EOFException {
    ...
    if (size < byteCount) {
      throw new java.io.EOFException("size < " + byteCount + ": " + size
  ...
  @Override public byte[] readByteArray(long byteCount) throws java.io.EOFException {
    checkOffsetAndCount(size, 0, byteCount);
    if (byteCount > Integer.MAX_VALUE) {
      throw new IllegalArgumentException("byteCount > Integer.MAX_VALUE: " + byteCount);
    }
  ...
  @Override public void readFully(byte[] sink) throws java.io.EOFException {
    int offset = 0;
  ...
  @Override public void skip(long byteCount) throws java.io.EOFException {
    while (byteCount > 0) {
      if (head == null) throw new java.io.EOFException();
  ...
  @Override public Buffer writeShortLe(int s) {
    return writeShort(utils.BytesUtils.reverseBytesShort((short) s));
  }
  ...
  @Override public Buffer writeIntLe(int i) {
    return writeInt(utils.BytesUtils.reverseBytesInt(i));
  }
  ...
  @Override public Buffer writeLongLe(long v) {
    return writeLong(utils.BytesUtils.reverseBytesLong(v));
  }
  ...
  @Override public long indexOf(ByteString bytes) throws java.io.IOException {
    return indexOf(bytes, 0);
  }

  @Override public long indexOf(ByteString bytes, long fromIndex) throws java.io.IOException {
