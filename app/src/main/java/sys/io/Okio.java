...
public final class Okio {
  ...
  private static Sink sink(final java.io.OutputStream out, final Timeout timeout) {
    if (out == null) throw new IllegalArgumentException("out == null");
    if (timeout == null) throw new IllegalArgumentException("timeout == null");

    return new Sink() {
      @Override public void write(Buffer source, long byteCount) throws java.io.IOException {
  ...
  private static Source source(final java.io.InputStream in, final Timeout timeout) {
    ...
    return new Source() {
      @Override public long read(Buffer sink, long byteCount) throws java.io.IOException {
        ...
        try {
          ...
          if (isAndroidGetsocknameError(e)) throw new java.io.IOException(e);
          throw e;
        }
      }
...
//    return source(java.nio.file.Files.newInputStream(path, options));
//  }
...
//    if (path == null) throw new IllegalArgumentException("path == null");
//    return sink(java.nio.file.Files.newOutputStream(path, options));
//  }
  ...
  private static AsyncTimeout timeout(final java.net.Socket socket) {
    return new AsyncTimeout() {
      @Override protected java.io.IOException newTimeoutException(java.io.IOException cause) {
    	  java.io.InterruptedIOException ioe = new java.net.SocketTimeoutException("timeout");
        if (cause != null) {
          ioe.initCause(cause);
        }
        return ioe;
