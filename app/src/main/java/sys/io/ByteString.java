...
import static sys.io.Util.arrayRangeEquals;
 ...
 */
public class ByteString implements java.io.Serializable, Comparable<ByteString> {
  ...
  private ByteString digest(String digest) {
    try {
      return ByteString.of(java.security.MessageDigest.getInstance(digest).digest(data));
  ...
  @Override public int hashCode() {
    int result = hashCode;
    return result != 0 ? result : (hashCode = java.util.Arrays.hashCode(data));
  }
  ...
  private void readObject(java.io.ObjectInputStream in) throws java.io.IOException {
    ...
    try {
    	java.lang.reflect.Field field = ByteString.class.getDeclaredField("data");
