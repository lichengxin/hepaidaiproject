...
public interface FileSystem {
  ...
  FileSystem SYSTEM = new FileSystem() {
    @Override public Source source(java.io.File file) throws java.io.FileNotFoundException {
      return Okio.source(file);
    }

    @Override public Sink sink(java.io.File file) throws java.io.FileNotFoundException {
      try {
    ...
    @Override public Sink appendingSink(java.io.File file) throws java.io.FileNotFoundException {
      try {
    ...
    @Override public void delete(java.io.File file) throws java.io.IOException {
    ...
    @Override public boolean exists(java.io.File file) throws java.io.IOException {
      return file.exists();
    }

    @Override public long size(java.io.File file) {
      return file.length();
    }

    @Override public void rename(java.io.File from, java.io.File to) throws java.io.IOException {
      delete(to);
      if (!from.renameTo(to)) {
    ...
    @Override public void deleteContents(java.io.File directory) throws java.io.IOException {
  ...
  Source source(java.io.File file) throws java.io.FileNotFoundException;

  /**
   * Writes to {@code file}, discarding any data already present. Creates parent directories if
   * necessary.
   */
  Sink sink(java.io.File file) throws java.io.FileNotFoundException;

  /**
   * Writes to {@code file}, appending if data is already present. Creates parent directories if
   * necessary.
   */
  Sink appendingSink(java.io.File file) throws java.io.FileNotFoundException;
  ...
  boolean exists(java.io.File file) throws java.io.IOException;
